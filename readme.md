...
1. **42-variables**: [index.html](https://github.com/chybeat/platzi-curso-definitivo-de-html-y-css/blob/main/clases/42-variables/index.html "Simply HTML layout") and [style.css](https://github.com/chybeat/platzi-curso-definitivo-de-html-y-css/blob/main/clases/42-variables/style.css "Use and declaration de variables in CSS") HTML layout basic for main footer and header, The CSS code has explanation about CSS variables declaration, and use. [View rendered code](https://chybeat.github.io/platzi-curso-definitivo-de-html-y-css/clases/42-variables/)
